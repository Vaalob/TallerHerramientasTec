...
public class frmWorker extends javax.swing.JFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(comAcc, javax.swing.GroupLayout.PREFERRED_SIZE, 148, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (txtTelefono.getText().length() == 0){
            JOptionPane.showConfirmDialog(rootPane, "Debes ingresar un telefono para el trabajador");
        ...
        int selec = comAcc.getSelectedIndex();
        dts.setAcceso((String) comAcc.getItemAt(selec));
    ...
    private void tablalistadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMouseClicked
        ...
        comAcc.setSelectedItem(tablalistado.getValueAt(fila, 4).toString());
        txtLogin.setText(tablalistado.getValueAt(fila, 5).toString());
        txtPass.setText(tablalistado.getValueAt(fila, 6).toString());
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (!txtPersona.getText().equals("")) {
            int confirm = JOptionPane.showConfirmDialog(rootPane, "Estar seguro de eliminar al trabajador", "confirmar", 2);
